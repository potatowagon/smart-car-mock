...
arduino/WInterrupts.o: C:/Program\ Files/Arduino/hardware/arduino/avr/cores/arduino/WInterrupts.c
	...
	avr-gcc -I"C:\Program Files\Arduino\hardware\arduino\avr\cores\arduino" -I"C:\Users\Sherry\Desktop\nus\CG2271\test\freeRTOS\Source\include" -I"C:\Program Files\Arduino\hardware\arduino\avr\variants\standard" -Wall -Os -fpack-struct -fshort-enums -ffunction-sections -fdata-sections -std=gnu99 -funsigned-char -funsigned-bitfields -mmcu=atmega328p -DF_CPU=16000000UL -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
